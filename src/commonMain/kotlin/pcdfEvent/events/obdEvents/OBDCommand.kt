...
enum class OBDCommand(val mode: Int, val pid: Int, val unit: String) {
    ...
    ABSOLUTE_THROTTLE_POSITION(1, 0x11, "%"),
    ...
    RELATIVE_THROTTLE_POSITION(1, 0x45, "%"),
    ...
    COMMANDED_EGR_AND_ERROR(1, 0x69, "struct"),
    NOX_SENSOR(1, 0x83, "ppm"),
    NOX_CONTROL_SYSTEM(1, 0x85, "struct"),
    SCR_INDUCEMENT_SYSTEM(1, 0x88, "struct"),
    AFTERTREATMENT_STATUS(1, 0x8B, "struct"),
