...
class NOXSensorCorrectedAlternativeEvent(
    source: String,
    timestamp: Long,
    bytes: String,
    pid: Int,
    ...
    override fun getPattern(): PCDFPattern {
        ...
        pattern.data = PCDFDataPattern(
            ...
            mode = mode,
            pid = pid,
            nox_sensor_corrected_alternative_1_1 = sensor1_1,
            nox_sensor_corrected_alternative_1_2 = sensor1_2,
            nox_sensor_corrected_alternative_2_1 = sensor2_1,
            nox_sensor_corrected_alternative_2_2 = sensor2_2
        )
        return pattern
    }
