...
class CatalystTemperature2_1Event(
    source: String,
    timestamp: Long,
    bytes: String,
    pid: Int,
    ...
    override fun getPattern(): PCDFPattern {
        ...
        pattern.data = PCDFDataPattern(
            ...
            mode = mode,
            pid = pid,
            catalyst_temperature_2_1 = temperature
        )
        return pattern
    }

    override fun toString(): String {
        return super.toString() + "Cat. Temp. 2 1: $temperature ${
            OBDCommand.CATALYST_TEMPERATURE_1_2.unit
        }"
    }
}