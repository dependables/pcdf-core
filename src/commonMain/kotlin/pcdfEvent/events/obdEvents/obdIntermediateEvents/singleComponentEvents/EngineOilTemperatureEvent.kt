...
class EngineOilTemperatureEvent(
    source: String,
    timestamp: Long,
    bytes: String,
    pid: Int,
    ...
    override fun getPattern(): PCDFPattern {
        ...
        pattern.data = PCDFDataPattern(
            ...
            mode = mode,
            pid = pid,
            engine_oil_temperature = temperature
        )
        return pattern
    }

    override fun toString(): String {
        return super.toString() + "Engine Oil Temperature: $temperature ${
            OBDCommand.ENGINE_OIL_TEMPERATURE.unit
        }"
    }
}